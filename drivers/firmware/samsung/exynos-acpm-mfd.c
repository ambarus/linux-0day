...
static void exynos_acpm_init_read_cmd(u32 *cmd, u8 type, u8 reg, u8 chan)
{
		       ...
		       u8 type, u8 reg, u8 chan, u8 *dest)
{
	...
	exynos_acpm_init_read_cmd(cmd, type, reg, chan);
...
static void exynos_acpm_init_bulk_read_cmd(u32 *cmd, u8 type, u8 reg, u8 chan,
					   u8 count)
{
	cmd[0] = FIELD_PREP(ACPM_PMIC_TYPE, type) |
		 FIELD_PREP(ACPM_PMIC_REG, reg) |
			...
			u8 type, u8 reg, u8 chan, u8 count, u8 *buf)
{
	...
	exynos_acpm_init_bulk_read_cmd(cmd, type, reg, chan, count);
...
static void exynos_acpm_init_write_cmd(u32 *cmd, u8 type, u8 reg, u8 chan,
				       u8 value)
{
	cmd[0] = FIELD_PREP(ACPM_PMIC_TYPE, type) |
		 FIELD_PREP(ACPM_PMIC_REG, reg) |
			...
			u8 type, u8 reg, u8 chan, u8 value)
{
	...
	exynos_acpm_init_write_cmd(cmd, type, reg, chan, value);
...
static void exynos_acpm_init_bulk_write_cmd(u32 *cmd, u8 type, u8 reg, u8 chan,
					    u8 count, u8 *buf)
{
	int i;
			 ...
			 u8 type, u8 reg, u8 chan, u8 count, u8 *buf)
{
	...
	exynos_acpm_init_bulk_write_cmd(cmd, type, reg, chan, count, buf);
...
static void exynos_acpm_init_update_cmd(u32 *cmd, u8 type, u8 reg, u8 chan,
					u8 value, u8 mask)
{
	cmd[0] = FIELD_PREP(ACPM_PMIC_TYPE, type) |
		 FIELD_PREP(ACPM_PMIC_REG, reg) |
			 ...
			 u8 type, u8 reg, u8 chan, u8 value, u8 mask)
{
	...
	exynos_acpm_init_update_cmd(cmd, type, reg, chan, value, mask);
