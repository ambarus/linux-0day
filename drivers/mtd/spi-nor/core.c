...
/**
 * spi_nor_skip_sfdp_init_params() - Initialize the flash's parameters and settings
 ...
 * SFDP standard, or where SFDP tables are incomplete or not defined at all.
 ...
 * tables are incomplete or not defined at all.
