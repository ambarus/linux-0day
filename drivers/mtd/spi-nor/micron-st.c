...
static const struct flash_info micron_parts[] = {
	{ "mt35xu512aba", INFO(0x2c5b1a, 0, 128 * 1024, 512)
		NON_SFDP_FLAGS(USE_FSR)
		SFDP_FLAGS(SECT_4K | SPI_NOR_OCTAL_READ |
...
static const struct flash_info st_parts[] = {
	{ "n25q016a",	 INFO(0x20bb15, 0, 64 * 1024,   32)
		SFDP_FLAGS(SECT_4K | SPI_NOR_QUAD_READ) },
	{ "n25q032",	 INFO(0x20ba16, 0, 64 * 1024,   64)
		SFDP_FLAGS(SPI_NOR_QUAD_READ) },
	...
	{ "n25q128a11",  INFO(0x20bb18, 0, 64 * 1024,  256)
		NON_SFDP_FLAGS(SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB |
	...
	{ "mt25ql256a",  INFO6(0x20ba19, 0x104400, 64 * 1024,  512)
		NON_SFDP_FLAGS(USE_FSR)
		SFDP_FLAGS(SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ)
		FIXUP_FLAGS(SPI_NOR_4B_OPCODES) },
	...
	{ "n25q512ax3",  INFO(0x20ba20, 0, 64 * 1024, 1024)
		NON_SFDP_FLAGS(USE_FSR | SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB |
	...
	{ "n25q00a",     INFO(0x20bb21, 0, 64 * 1024, 2048)
		NON_SFDP_FLAGS(NO_CHIP_ERASE | USE_FSR)
		SFDP_FLAGS(SECT_4K | SPI_NOR_QUAD_READ) },
