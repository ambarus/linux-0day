...
static const struct flash_info spansion_parts[] = {
	...
	{ "s25fl256s0", INFO6(0x010219, 0x4d0080, 256 * 1024, 128)
		NON_SFDP_FLAGS(USE_CLSR)
		SFDP_FLAGS(SPI_NOR_SKIP_SFDP | SPI_NOR_DUAL_READ |
			   SPI_NOR_QUAD_READ) },
	{ "s25fl256s1", INFO6(0x010219, 0x4d0180, 64 * 1024, 512)
		NON_SFDP_FLAGS(USE_CLSR)
		SFDP_FLAGS(SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ "s25fl512s",  INFO6(0x010220, 0x4d0080, 256 * 1024, 256)
		NON_SFDP_FLAGS(SPI_NOR_HAS_LOCK | USE_CLSR)
		SFDP_FLAGS(SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	{ "s25fl204k",  INFO(0x014013,      0,  64 * 1024,   8)
		SFDP_FLAGS(SECT_4K | SPI_NOR_DUAL_READ) },
	...
	{ "cy15x104q",  INFO6(0x042cc2, 0x7f7f7f, 512 * 1024, 1)
		NON_SFDP_FLAGS(SPI_NOR_NO_ERASE) },
	{ "s28hs512t",   INFO(0x345b1a,      0, 256 * 1024, 256)
		SFDP_FLAGS(SECT_4K | SPI_NOR_OCTAL_DTR_READ |
