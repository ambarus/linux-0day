 ...
 * @non_sfdp_flags: flags that indicate support that is not defined by the
 ...
 *                            status register.
 *
 * @sfdp_flags:     flags that indicate support that can be discovered via SFDP.
...
#define CAT25_INFO(_sector_size, _n_sectors, _page_size, _addr_width)	\
		...
		.non_sfdp_flags = SPI_NOR_NO_ERASE | SPI_NOR_NO_FR,	\
...
#define S3AN_INFO(_jedec_id, _n_sectors, _page_size)			\
		...
		.page_size = _page_size,				\
		.addr_width = 3,					\
		.non_sfdp_flags = SPI_NOR_NO_FR | SPI_NOR_XSR_RDY,
...
#define NON_SFDP_FLAGS(_non_sfdp_flags)					\
		.non_sfdp_flags = (_non_sfdp_flags),			\

#define SFDP_FLAGS(_sfdp_flags)						\
		.sfdp_flags = (_sfdp_flags),				\
