...
static SPINAND_OP_VARIANTS(read_cache_variants,
		...
		SPINAND_PAGE_READ_FROM_CACHE_DUALIO_OP(0, 4, NULL, 0),
...
static SPINAND_OP_VARIANTS(read_cache_variants_f,
		SPINAND_PAGE_READ_FROM_CACHE_QUADIO_OP(0, 2, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_X4_OP_3A(0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_DUALIO_OP(0, 4, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_X2_OP_3A(0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_OP_3A(true, 0, 8, NULL, 0),
...
static SPINAND_OP_VARIANTS(read_cache_variants_2gq5,
		...
		SPINAND_PAGE_READ_FROM_CACHE_X4_OP(0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_DUALIO_OP(0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_X2_OP(0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_OP(true, 0, 8, NULL, 0),
		SPINAND_PAGE_READ_FROM_CACHE_OP(false, 0, 8, NULL, 0));
